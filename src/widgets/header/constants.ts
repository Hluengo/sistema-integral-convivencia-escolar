...
export const VIEW_TITLES: Record<
  SidebarView,
...
> = {
  ...
  reportes: {
    ...
    subtitle: "Indicadores, filtros e historial",
  },
  anotaciones: {
    title: "Gestión de Anotaciones",
    subtitle: "Documentos y hojas de vida",
  },
  admin: {
    title: "Administración",
    subtitle: "Configuración y control del establecimiento",
  },
  platform: {
    title: "Plataforma",
