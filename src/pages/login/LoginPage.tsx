    ...
    >
      ...
      >
        ...
        <div className="p-8 pb-7">
          ...
          {error && (
            <div role="alert" className="mb-5 flex items-start gap-3 rounded-xl border border-red-100 bg-red-50 p-3.5 text-red-600 text-sm">
              <AlertCircle className="mt-0.5 h-4 w-4 shrink-0" />
              <span>{error}</span>
            </div>
          )}
          {notice && (
            <div role="status" className="mb-5 flex items-start gap-3 rounded-xl border border-emerald-100 bg-emerald-50 p-3.5 text-emerald-700 text-sm">
          ...
          {mode !== 'update-password' && (
            <div className="mb-4">
              <label htmlFor="login-email" className="mb-1.5 block font-semibold text-neutral-600 text-xs">
                Correo electrónico
              </label>
              <input
                ref={emailRef}
          ...
          {mode === 'login' && (
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <PrimaryButton loading={isLoading} label="Iniciar sesión" loadingLabel="Ingresando..." />
            </form>
          )}
          ...
          {mode === 'update-password' && (
            <form onSubmit={handlePasswordUpdate} className="space-y-4">
              ...
              <PasswordInput
                ...
                autoComplete="new-password"
              />
              <PrimaryButton loading={isLoading} label="Guardar contraseña" loadingLabel="Guardando..." />
            </form>
          )}
        </div>
