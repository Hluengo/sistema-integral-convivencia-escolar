...
export const getBaseChecklist = (
  ...
  // 1. Recepción y Apertura (chk_rec_1, chk_rec_2, chk_rec_3)
  {
    ...
    descripcion:
      "Se recibe formalmente el reporte, denuncia o antecedente inicial.",
    completado: false,
  ...
  },
  {
    ...
    descripcion:
      "Se realiza acopio preliminar de información y verificación básica de los hechos.",
    completado: false,
  ...
  },
  {
    ...
    descripcion:
      "Las partes participan activamente en proceso de resolución colaborativa.",
    completado: false,
    requeridoPor: "Reglamento Interno",
  },
  {
    ...
    descripcion:
      "Se logra acuerdo restaurativo y se suspende o cierra el proceso disciplinario.",
    completado: false,
    requeridoPor: "Reglamento Interno",
  },
  {
    ...
    descripcion:
      "No existe acuerdo o no se cumplen condiciones para mediación.",
    completado: false,
    requeridoPor: "Reglamento Interno",
  },
  ...
  ...(proceduralModelVersion === 2
    ? [
        {
          id: "chk_inv_7",
          label: "Comunicación de Antecedentes",
          descripcion:
            "Se comunican los antecedentes relevantes a las personas intervinientes.",
          completado: false,
          requeridoPor: "Circular 482" as const,
        },
        {
          id: "chk_inv_8",
          label: "Descargos Recibidos o Plazo Vencido",
          descripcion:
            "Se registran los descargos o el vencimiento del plazo para presentarlos.",
          completado: false,
          requeridoPor: "Circular 482" as const,
        },
        {
          id: "chk_inv_9",
          label: "Cierre Formal de la Indagación",
          descripcion:
            "Se cierra formalmente la etapa de indagación con sus antecedentes registrados.",
          completado: false,
          requeridoPor: "Circular 482" as const,
        },
      ]
  ...
  // se conservan para expedientes históricos, pero no son hitos operativos.
  {
    ...
    descripcion:
      "El Encargado de la indagación sistematiza antecedentes y redacta conclusiones.",
    completado: false,
    requeridoPor: "Circular 482",
  },
  {
    ...
    descripcion:
      "El informe técnico fue entregado a Equipo de Convivencia Escolar para Revisión.",
    completado: false,
    requeridoPor: "Circular 482",
  },
  {
    ...
    descripcion:
      "Citación realizada a estudiante y apoderado para presentación de hallazgos.",
    completado: false,
    requeridoPor: "Ambas",
  },
  {
    ...
    descripcion:
      "Se efectuó audiencia disciplinaria y ejercicio del derecho a ser oído.",
    completado: false,
    requeridoPor: "Ambas",
  },
  {
  ...
  },
  {
    ...
    descripcion:
      "Se entrega formalmente resolución Formativa y disciplinaria al apoderado.",
    completado: false,
    requeridoPor: "Ambas",
  },
  ...
  ...(proceduralModelVersion === 2
    ? [
        {
          id: "chk_res_7",
          label: "Hechos y Participación Individual Analizados",
          descripcion:
            "Se analizan los hechos acreditados y la participación individual.",
          completado: false,
          requeridoPor: "Circular 482" as const,
        },
        {
          id: "chk_res_8",
          label: "RICE, Historial y Proporcionalidad Analizados",
          descripcion:
            "Se revisan RICE, historial y proporcionalidad de la decisión.",
          completado: false,
          requeridoPor: "Ambas" as const,
        },
        {
          id: "chk_res_9",
          label: "Decisión Fundada Incorporada",
          descripcion:
            "Se incorpora externamente la decisión fundada, sin redactarla automáticamente.",
          completado: false,
          requeridoPor: "Ambas" as const,
        },
      ]
  ...
  },
  {
    ...
    descripcion:
      "Se recibe formalmente recurso de reconsideración o apelación.",
    completado: false,
    requeridoPor: "Ley 21809",
  },
  {
    ...
    descripcion:
      "Autoridad competente analiza antecedentes y emite resolución definitiva.",
    completado: false,
    requeridoPor: "Ley 21809",
  },
  {
    ...
    descripcion:
      "Se confirma, modifica o revoca la medida inicialmente aplicada.",
    completado: false,
    requeridoPor: "Ley 21809",
  },
  {
    ...
    descripcion:
      "Finaliza completamente el debido proceso administrativo interno.",
    completado: false,
    requeridoPor: "Ley 21809",
  },
  ...
  ...(proceduralModelVersion === 2
    ? [
        {
          id: "chk_imp_6",
          label: "Plazo Vencido sin Reconsideración o Apelación",
          descripcion:
            "Se registra el vencimiento del plazo sin presentación de solicitud.",
          completado: false,
          requeridoPor: "Ley 21809" as const,
        },
        {
          id: "chk_imp_7",
          label: "Decisión Definitiva Notificada",
          descripcion: "Se notifica la decisión definitiva del procedimiento.",
          completado: false,
          requeridoPor: "Ley 21809" as const,
        },
      ]
  ...
  },
  {
    ...
    descripcion:
      "Se monitorea cumplimiento, conducta y evolución del estudiante.",
    completado: false,
    requeridoPor: "Circular 482",
  },
  {
  ...
  return getBaseChecklist().map((baseItem) => {
    ...
    if (override) {
      return {
        ...
        observaciones:
          override.observaciones ||
          "Hito procesal cerrado conforme a debido proceso.",
...
export const getStats = (causas: Causa[]): Statistics => {
  ...
  causas.forEach((c) => {
    ...
    stats.porGravedad[c.tipoInfraccion] =
      (stats.porGravedad[c.tipoInfraccion] || 0) + 1;
