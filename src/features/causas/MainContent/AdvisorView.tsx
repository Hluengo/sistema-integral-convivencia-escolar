    ...
    <div className="animate-fade-in space-y-6">
      ...
      >
        <button
          ...
          className="inline-flex min-h-11 min-w-max flex-1 items-center justify-center gap-2 rounded-lg border border-brand-200 bg-white px-3.5 py-2 font-semibold text-brand-800 text-xs shadow-sm sm:px-4"
        >
      ...
      <div
        id="legal-panel-consulta"
        role="tabpanel"
        aria-labelledby="legal-tab-consulta"
      >
        <AiAdvisor />
      </div>
    </div>
