...
export type ActiveTab =
  "estado" | "editar_anotaciones" | "revisar_pdf" | "cartas" | "historial";
...
export const TAB_ICONS: Record<ActiveTab, React.ReactNode> = {
  estado: <FileText className="h-4 w-4" aria-hidden="true" />,
  editar_anotaciones: <Pencil className="h-4 w-4" aria-hidden="true" />,
  revisar_pdf: <FileSearch className="h-4 w-4" aria-hidden="true" />,
  cartas: <ScrollText className="h-4 w-4" aria-hidden="true" />,
  historial: <History className="h-4 w-4" aria-hidden="true" />,
};

export const TAB_LABELS: Record<ActiveTab, string> = {
  estado: "Resumen",
  editar_anotaciones: "Anotaciones",
