...
export default function ManualHistoryEntryForm({
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      await onSave({ studentId, title, description });
      setIsOpen(false);
      setTitle('');
      setDescription('');
      onResetError();
    ...
    >
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="mt-0.5 text-neutral-500 text-xs">
              No modifica anotaciones, cartas ni etapas disciplinarias.
            </p>
          </div>
        </div>
        <button
      ...
      <div>
        <div className="mb-1.5 flex items-center justify-between gap-3">
          <label htmlFor="manual-history-title" className="font-semibold text-neutral-700 text-sm">
            Título
          </label>
      ...
      <div>
        <div className="mb-1.5 flex items-center justify-between gap-3">
          <label
            htmlFor="manual-history-description"
