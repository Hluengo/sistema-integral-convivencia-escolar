  ...
  return (
    <div className="space-y-4">
      <div className="mx-auto w-full max-w-[210mm] rounded-xl border border-neutral-200 bg-white p-4 shadow-xs">
        <p className="mb-3 text-xs font-semibold uppercase tracking-wider text-neutral-500">Acciones del Documento</p>
      ...
      <div className="overflow-x-auto pb-2">
        <div ref={ref} id="document-preview-a4" className="mx-auto min-h-[297mm] w-[210mm] max-w-full rounded-xl border border-neutral-200 bg-white p-8 shadow-lg print:border-none print:p-0 print:shadow-none">
          <div className="mb-5 flex items-center gap-4 border-b-2 border-neutral-300 pb-5">
            ...
            <div className="flex flex-col">
              <span className="text-[10px] font-semibold uppercase tracking-widest text-neutral-500">Fundación Educacional Colegio Carmela Romero de Espinosa</span>
              <span className="mt-0.5 text-sm font-bold text-neutral-800">DIRECCIÓN DE CONVIVENCIA ESCOLAR</span>
              <span className="text-[11px] text-neutral-500">Año 2026</span>
            </div>
          </div>

          <h2 className="mb-6 text-center text-lg font-extrabold uppercase tracking-wide text-neutral-900">{title}</h2>
