...
export default function IncidentePanel({
  causa,
  privacyMode,
}: IncidentePanelProps) {
          ...
          <div className="mt-4 rounded-lg border border-brand-200 bg-white/70 p-3">
            ...
            <div className="mt-2 space-y-2">
              {data.activity.map((activity) => {
                const source = data.causas.find(
                  (linkedCausa) => linkedCausa.id === activity.sourceCausaId,
                );
                return (
                  <article
                  ...
                  >
                    ...
                    <p className="mt-1.5 whitespace-pre-wrap text-neutral-600 text-11px">
                    ...
                    {activity.documentUrl && (
                      <button
                        type="button"
                        onClick={() =>
                          void openDocument(activity.documentUrl || "")
                        }
