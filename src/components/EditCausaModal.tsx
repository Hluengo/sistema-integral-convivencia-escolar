...
import { AlertDialog, AlertDialogContent, AlertDialogHeader, AlertDialogIcon, AlertDialogTitle, AlertDialogDescription, AlertDialogFooter, AlertDialogCancel, AlertDialogAction } from './ui/AlertDialog';
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-left text-neutral-800 text-sm">
              ...
              <div className="flex items-center justify-between gap-2 border-t border-neutral-100 pt-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    type="submit"
                    className="flex cursor-pointer items-center gap-2 rounded-xl bg-brand-600 px-5 py-2.5 font-semibold text-white shadow-sm shadow-brand-600/20 transition-all hover:scale-[1.02] hover:bg-brand-700 active:scale-95"
                  >
