  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 px-4 py-3 border-b border-neutral-100">
        ...
        />
        <kbd className="hidden sm:inline-flex items-center gap-0.5 px-1.5 py-0.5 text-[10px] font-mono text-neutral-400 bg-neutral-100 rounded border border-neutral-200">
          ESC
        </kbd>
      </div>
      ...
      <div className="px-4 py-2 border-t border-neutral-100 flex items-center gap-4 text-[10px] text-neutral-400">
        <span className="flex items-center gap-1">
          <kbd className="font-mono px-1 py-0.5 bg-neutral-100 rounded border border-neutral-200">↑↓</kbd>
          navegar
        </span>
        <span className="flex items-center gap-1">
          <kbd className="font-mono px-1 py-0.5 bg-neutral-100 rounded border border-neutral-200">↵</kbd>
        ...
        <span className="flex items-center gap-1">
          <kbd className="font-mono px-1 py-0.5 bg-neutral-100 rounded border border-neutral-200">esc</kbd>
          cerrar
        </span>
      </div>
    </dialog>
