...
| P-01 | Aplicar `privacyMode` a los rankings del dashboard    | `MainContent.tsx`, `DashboardStats.tsx`, `AnotacionesDashboardStats.tsx`, `TeacherAnnotationRanking.tsx`, `StudentAnnotationRanking.tsx`, `annotationRankingCardItems.ts` | Bajo — nombres de docentes y estudiantes quedaban visibles con privacidad activada; ahora se enmascaran con `maskName` |
