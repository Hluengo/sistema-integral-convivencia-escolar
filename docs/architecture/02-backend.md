...
Gemini is used for due-process audits, reports, and official document drafts. OpenRouter remains available for brief legal assistance; complex document/report endpoints do not fall back to OpenRouter.
