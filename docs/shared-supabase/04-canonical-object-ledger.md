...
| `bitacora_entries`                  | TABLE | public | CONVIVENCIA | convivencia     | convivencia_migration | SÍ              | 003_causas, 004_bitacora             | SÍ (tenant_id NOT NULL, DEFAULT current_tenant_id()) | SÍ  | bitacora_tenant_select/insert/update/delete            | PROPIEDAD DE CONVIVENCIA | ALTO   | Conservar     |
| `checklist_items`                   | TABLE | public | CONVIVENCIA | convivencia     | convivencia_migration | SÍ              | 005_checklist                        | SÍ (tenant_id NOT NULL, DEFAULT current_tenant_id()) | SÍ  | checklist_tenant_select/insert/update/delete           | PROPIEDAD DE CONVIVENCIA | MEDIO  | Conservar     |
| `cartas_disciplinarias`             | TABLE | public | CONVIVENCIA | convivencia     | convivencia_migration | SÍ              | 006_cartas                           | SÍ (tenant_id NOT NULL, DEFAULT current_tenant_id()) | SÍ  | cartas_tenant_select/insert/update/delete              | PROPIEDAD DE CONVIVENCIA | MEDIO  | Conservar     |
| `etapas_disciplinarias`             | TABLE | public | CONVIVENCIA | convivencia     | convivencia_migration | SÍ              | 006_cartas                           | SÍ (tenant_id NOT NULL, DEFAULT current_tenant_id()) | SÍ  | etapas_tenant_select/insert/update/delete              | PROPIEDAD DE CONVIVENCIA | MEDIO  | Conservar     |
...
| `document_analyses`                 | TABLE | public | CONVIVENCIA | convivencia     | convivencia_migration | SÍ              | Migración IA (no identificada)       | SÍ (tenant_id NOT NULL)                              | SÍ  | tenant_analyses (ALL)                                  | PROPIEDAD DE CONVIVENCIA | MEDIO  | Conservar     |
| `disciplinary_processes`            | TABLE | public | CONVIVENCIA | convivencia     | convivencia_migration | SÍ              | Migración procesos (no identificada) | SÍ (tenant_id NOT NULL)                              | SÍ  | tenant_processes (ALL)                                 | PROPIEDAD DE CONVIVENCIA | ALTO   | Conservar     |
...
| `disciplinary_rules`                | TABLE | public | CONVIVENCIA | convivencia     | convivencia_migration | SÍ              | Migración procesos (no identificada) | SÍ (tenant_id NOT NULL)                              | SÍ  | tenant_rules (ALL)                                     | PROPIEDAD DE CONVIVENCIA | BAJO   | Conservar     |
