...
| 14  | **NUNCA duplicar una ruta entre los entry points del servidor**       | La implementación canónica vive en `server/api/routes/` y ambos entry points deben registrarla. |
...
| No registrar una ruta canónica en ambos entry points | API rota en desarrollo o producción — GRAVE            |
| Usar `any`                                           | Deuda técnica, bugs silenciosos — MEDIO                |
| No testear                                           | Regresiones inesperadas — MEDIO                        |

---

_Esta constitución es un documento vivo. Para modificarla, crear un ADR explicando por qué la regla debe cambiar._
